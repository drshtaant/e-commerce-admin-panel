...
/**
 * Sends text type body email via transaction email transport.
 *
 * This will scheduled a text type body email on The Email Service provider and the
 * service will send the e-mail in an immediate future time.
 *
 * @param from
 * @param to
 * @param subject
...
/**
 * Sends text type body email via marketing email transport.
 *
 * This will scheduled a text type body email on The Email Service provider and the
 * service will send the e-mail in an immediate future time.
 *
 ...
 *
 * {.., "messageId": "<ca6029d0-1304-32fe-6a49-634e5a92f326@dev.example.tld>"", ...}
 *
